...
/**
 * Every quote call-to-action on a vertical page. A service the API has flagged
 * as coming soon says so rather than sending someone to a form that will not
 * offer it — QuoteRequestForm filters unavailable services out.
 */
function QuoteCta({
  cta,
  dark,
  ...
  cta: { comingSoon: boolean; href: string };
  dark?: boolean;
  ...
  return (
    <PillArrowBtn href={cta.href} dark={dark}>
      {children}
    </PillArrowBtn>
  );
}
...
export default async function VerticalPage({ params }: Props) {
  ...
  const cta = { comingSoon, href: quoteHref };
        ...
        <div className="relative mx-auto max-w-[1376px] px-4 sm:px-8">
          <div className="grid items-center gap-10 pt-14 lg:grid-cols-[1.25fr_0.75fr] lg:gap-16 lg:pt-20">
            ...
            <div className="fade-up fade-up-1">
              ...
              <div className="mt-6">
                <QuoteCta cta={cta}>{vertical.hero.cta}</QuoteCta>
              </div>
            </div>
          </div>
        </div>
      ...
      <section className="bg-paper">
        <div className="mx-auto grid max-w-[1376px] items-center gap-14 px-4 py-24 sm:px-8 lg:grid-cols-[0.9fr_1.1fr]">
          ...
          <Reveal delay={150}>
            ...
            <div className="mt-9">
              <QuoteCta cta={cta}>Get a Quote</QuoteCta>
            </div>
          </Reveal>
        </div>
      </section>
